...
results_mymethod = [pool.apply(mtvgl.myTVGL, args=(X_concat_list, ni, parameters[0], parameters[1], indexOfPenalty, True, h)) for parameters in mesh_parameters]
